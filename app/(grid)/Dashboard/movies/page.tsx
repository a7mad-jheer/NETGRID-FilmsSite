...
//     { type: moviesType[1].data.data.results, movies: "top Rated" },
//     { type: moviesType[2].data.data.results, movies: "up Coming" },
//     { type: moviesType[3].data.data.results, movies: "now Playing" },
//   ];
