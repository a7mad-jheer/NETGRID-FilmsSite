...
import { AlertDialogDemo } from "./ShowDialog/ShowDialog";
...
export default function SimpleCard({ title, imageSrc }: CardProps) {
  return (
    <>
<div className="bg-neutral-primary-soft   w-full block rounded-base shadow-xs mb-10">
    <div className="w-full h-80 relative block overflow-hidden rounded-t-base">
        <Image 
        fill
        className="rounded-t-base relative " 
    ...
    <div className="p-6 text-center flex flex-col items-center">
        ...
        <Link href="/loginPage" className="inline-flex items-center text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none cursor-pointer">
            <AlertDialogDemo btnText ="Show Now" title= "Don't miss out!" desc="Log in to make the most of our website. " link="/loginPage"/>
